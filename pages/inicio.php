					...
					<div class="padding-5">
						<div class="uk-inline">
							<div class="uk-text-center padding-10 color-white" style="min-height: 14em;background-color:#805179">
								<h3 class="color-white text-xxl"><?=$row_consulta2['titulo']?></h3>
								<div class="text-7"><?=$row_consulta2['txt']?></div>
							</div>
							<a href="1_servicio-detalle"><div class="uk-position-bottom-right bg-white uk-text-center padding-h-10"> <i class="fas fa-chevron-right"></i></div></a>
						</div>
					</div>
				<?php } ?>
