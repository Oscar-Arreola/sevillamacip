	...
	$(document).ready(function() {
		$("#fileuploader").uploadFile({
			...
			onSuccess:function(data){ 
				window.location = (\'index.php?rand='.rand(1,1000).'&modulo='.$modulo.'&position=gallery&uploadedfile=\'+data);
			}
		});
	});
