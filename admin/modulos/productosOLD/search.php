		...
		<table class="uk-table uk-table-striped uk-table-hover uk-table-small uk-table-middle uk-table-responsive" id="ordenar">
			<thead>
				<tr>
					...
					<th width="10px"  class="pointer" onclick="sortTable(3)"></th>
					<th width="100px" class="pointer" onclick="sortTable(4)"></th>
					<th width="90px"  class="pointer" onclick="sortTable(5)"></th>
