...
echo '
	<div class="uk-width-auto margin-top-20 uk-text-left">
		<ul class="uk-breadcrumb uk-text-capitalize">
			...
			<li><a href="index.php?rand='.rand(1,1000).'&modulo='.$modulo.'&archivo=cfgmarcas" class="color-red">Tipos</a></li>
		</ul>
	</div>
		...
		<div class="uk-container uk-container-small">
			<div class="uk-card uk-card-default uk-card-body uk-border-rounded">
				...
				<div class="uk-text-right uk-margin">
					<a href="#add" uk-toggle class="uk-button uk-button-success"><i uk-icon="plus"></i> &nbsp; Nuevo Tipo</a>
				</div>
