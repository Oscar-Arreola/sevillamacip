<?php 
	...
	$genero				= $rowConsultaItem['genero'];
	$claves				= $rowConsultaItem['claves'];
	...
	echo '
		<div class="uk-width-1-2@s margin-v-20">
			<div class="uk-card uk-card-default uk-card-body">
				...
				<div>
					<span class="uk-text-capitalize uk-text-muted">Genero:</span>
					'.$rowConsultaItem['genero'].'
				</div>
				<div>
...
$scripts='
	...
	$("#fileuploader").uploadFile({
		...
		onSuccess:function(data){ 
			window.location = ("index.php?rand='.rand(1,1000).'&modulo='.$modulo.'&archivo='.$archivo.'&id='.$id.'&uploadedfile="+data);
		}
	});
