...
/* %%%%%%%%%%%%%%%%% CONFIGURACIÓN   */
	...
	$databaseLocal 	= 'sevillamacip';
	$usernameLocal 	= 'root';
	$passwordLocal 	= '';

	$previewDomain  = 'proyectoswozial.com';
	$databasePreview= 'proye205_robert';
	$usernamePreview= 'proye205_wozialpro';
	$passwordPreview= 'n#2!3zSBHNir';
...
/* %%%%%%%%%%%%%%%%% OTRAS VARIABLES   */
	...
	global $linkToShare;
	global $es_movil;
	global $sliderAutoplay;



	$sliderAutoplay = 'autoplay:true; autoplay-interval: 4000;';
	...
	// Metadatos
		...
		$logoOg 	       = (file_exists($logoOg) AND strlen($row_CONSULTA['imagen1'])>0) ? $logoOg:'img/design/logo.png';
		...
		$txt_t1				= $row_CONSULTA['txt_t1'];	
		$txt_s1				= $row_CONSULTA['txt_s1'];	
		$txt_t2				= $row_CONSULTA['txt_t2'];	
		$txt_s2				= $row_CONSULTA['txt_s2'];	
		$txt_s3				= $row_CONSULTA['txt_s3'];	
