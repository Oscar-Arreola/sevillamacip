...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  */
	...
	$loginButton    = '
		<div>
			<a href="#login" class="uk-button" style="margin-right: 30px" uk-toggle>
	...
	if (isset($uid)) {
		$loginButton='
		<div>
			<a href="'.$rutaMiCta.'" class=" uk-button uk-text-center">
				<i uk-icon="user"></i><span class="uk-visible@s"> &nbsp; Hola '.$nombreCorto.'</span>
			</a>
			<a href="logout" class="bg-white uk-button uk-text-center" style="border: 2px solid black; border-radius: 25px 0px 0px 25px;">
				<i uk-icon="lock"></i>
			</a>
		</div>
		';
